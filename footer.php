<footer class=clearfix>
	<ul class=clearfix>
		...
		<li id=form>
			<h2>Pridėk <a href=http://plus.google.com>Google+</a> lietuvį</h2>
			<p><a href=http://plus.google.com>Google+</a> lietuvį gali pridėti įvesdamas jo profilio URL (pvz.: <span id=sample>https://plus.google.com/u/0/117118694151742553199</span>):</p>
			<?php require('add-profile.php'); ?>
		</li>
	</ul>
</footer>
