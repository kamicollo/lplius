...
//    public $gender; //where is this?
    ...
    protected function loadFromRowResult( $row ) {
    ...
    protected function loadFromGooglePlusJSON( $data ) {
        $this->googleplus_id = $data[0][1][0];
        $this->profile_photo = $data[0][1][2][3];
        $this->first_name = $data[0][1][2][4][1];
        $this->last_name = $data[0][1][2][4][2];
        $this->introduction = $data[0][1][2][14][1];
        $this->subhead = $data[0][1][2][33][1];
